...
export function ProductRecordCard({
  ...
  return (
    <Link
      ...
      className="group grid gap-4 border-t border-border-default py-5 transition hover:bg-surface-subtle md:grid-cols-[96px_160px_1fr_160px]"
    >
      <div className="font-mono text-xs uppercase tracking-meta text-text-secondary">
        {entry.entryNumber}
      </div>
      <ImageFrame
        src={entry.image}
