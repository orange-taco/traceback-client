  ...
  return (
    <section className="mx-auto max-w-sm px-4 py-10">
      <form onSubmit={handleSubmit} className="grid gap-4 border border-border-default p-5">
        ...
        <label>
          <span className="meta mb-2 block">Current password (optional for Kakao-only accounts)</span>
          <input name="currentPassword" type="password" autoComplete="current-password" disabled={isSubmitting} className={inputClass} />
        </label>
        <label>
