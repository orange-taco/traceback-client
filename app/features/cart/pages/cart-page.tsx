  ...
  return (
    <div>
      ...
      <section className="px-4 py-8 md:px-8">
        <div className="grid gap-4 border-y border-border-default py-5 md:grid-cols-[120px_1fr_160px_120px_160px] md:items-center">
          ...
          <p className="font-mono text-xs uppercase tracking-meta text-text-secondary">
            Option: Black / M
          </p>
        ...
        <div className="ml-auto mt-8 max-w-md divide-y divide-border-default border-y border-border-default font-mono text-xs uppercase tracking-meta">
          {[
